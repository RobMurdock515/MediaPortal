...
{
    internal class AacFileReader
    {
        public static (Dictionary<string, string> metadata, TimeSpan duration)? ReadAacFile(string filePath)
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"Error reading AAC file: {ex.Message}");
                return null;
            }
        }
    }
